...
export default function Home() {
  return (
    <>
      <Head>
        <title>1CМобайл - Управляйте заказами с телефона</title>
        <meta name="description" content="Позвольте клиентам делать заказы напрямую через мобильное приложение. Заказы мгновенно попадают в вашу базу данных 1C, ускоряя работу предприятия на 30% и более." />
        <meta name="keywords" content="1C, мобильное приложение, заказы, управление, бизнес" />
      </Head>
